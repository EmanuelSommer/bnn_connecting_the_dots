...
def load_config():
    ...
    config_path = 'experiments/fcn_bnns/config.yaml'
...
def run_experiment(config: dict, exp_name: str, exp: tuple, date: str) -> None:
    ...
    if exp_dict['warmstart'] == 'single':
        ...
        raise ValueError('Warmstart not implemented')

    # define a helper function to get the posterior samples
    def get_mcmc_samples(mcmc_learner, rng_key, params_dict=None):
